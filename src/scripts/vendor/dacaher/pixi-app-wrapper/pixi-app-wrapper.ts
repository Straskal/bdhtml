...
import "fpsmeter";
import {Dom, pixiAppWrapperEvent} from "vendor/dacaher/pixi-app-wrapper";
import "pixi-layers";
import * as PIXI from "pixi.js";
import * as screenfull from "vendor/sindresorhus/screenfull/screenfull";
import {MediaInfoData, MediaInfoViewer} from "vendor/dacaher/pixi-app-wrapper/info/media-info-viewer";
import {AlignBottomCenter} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-bottom-center";
import {AlignBottomLeft} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-bottom-left";
import {AlignBottomRight} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-bottom-right";
import {AlignMiddle} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-middle";
import {AlignMiddleLeft} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-middle-left";
import {AlignMiddleRight} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-middle-right";
import {AlignStrategy} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-strategy";
import {AlignTopCenter} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-top-center";
import {AlignTopLeft} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-top-left";
import {AlignTopRight} from "vendor/dacaher/pixi-app-wrapper/stage/align/align-top-right";
import {ScaleFullSize} from "vendor/dacaher/pixi-app-wrapper/stage/scale/scale-full-size";
import {ScaleKeepAspectRatio} from "vendor/dacaher/pixi-app-wrapper/stage/scale/scale-keep-aspect-ratio";
import {ScaleNone} from "vendor/dacaher/pixi-app-wrapper/stage/scale/scale-none";
